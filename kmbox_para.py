CMD_connect = 0xaf3c2828  # 连接盒子
CMD_mouse_move = 0xaede7345  # 鼠标移动
CMD_mouse_left = 0x9823AE8D  # 鼠标左键控制
CMD_mouse_middle = 0x97a3AE8D  # 鼠标中键控制
CMD_mouse_right = 0x238d8212  # 鼠标右键控制
CMD_mouse_wheel = 0xffeead38  # 鼠标滚轮控制
CMD_mouse_automove = 0xaede7346  # 鼠标自动模拟人工移动控制
CMD_keyboard_all = 0x123c2c2f  # 键盘所有参数控制
CMD_reboot = 0xaa8855aa  # 盒子重启
CMD_bazerMove = 0xa238455a  # 鼠标贝塞尔移动
CMD_monitor = 0x27388020  # 监控盒子上的物理键鼠数据
CMD_debug = 0x27382021  # 开启调试信息
CMD_mask_mouse = 0x23234343  # 屏蔽物理键鼠
CMD_unmask_all = 0x23344343  # 解除屏蔽物理键鼠
CMD_setconfig = 0x1d3d3323  # 设置IP配置信息
CMD_setvidpid = 0xffed3232  # 设置device端的vidpid
CMD_showpic = 0x12334883  # 显示图片
CMD_trace_enable = 0xbbcdddac  # 使能硬件修正功能
